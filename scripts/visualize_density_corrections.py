...
parser.add_argument("--cdens", required=False, default=col_dens, help="Column density (hydrogen number)")
parser.add_argument("--radius", required=False, default=core_radius, help="Core radius (in parsec)")
