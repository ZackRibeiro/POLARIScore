...
Generate a standalone python file to train networks with all needed functions, i.e without external calls.
You'll need to modify the setup part at the end of the file.
Example usage: To train neural networks on external computers that don't have all the librairies used by this code installed.
"""
